...
# DNS PATCH
#tipeos2=$(uname -m)
Name=$(curl -sS https://raw.githubusercontent.com/ignelson/supreme/aio/permission/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/ingnelson/supreme/aio/permission/ip | grep $MYIP | awk '{print $3}')
# GETTING DOMAIN NAME
